...
public class RoleModel {
	...
	public Integer nextPk() throws DatabaseException {
		...
		pstmt.close();
			...
			throw new DatabaseException("Exception : Exception is getting in PK" + e.getMessage());
	...
	public void update(RoleBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			throw new ApplicationException("Exception in updation role" + e.getMessage());
		}finally {
			JDBCDataSource.closeConnection(conn);
		}
	}
	...
	public RoleBean findByName(String name) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in getting User by Role" + e.getMessage());
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
		return bean;
