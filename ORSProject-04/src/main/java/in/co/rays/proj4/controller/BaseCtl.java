...
/**
 * BaseCtl is an abstract base controller class that provides common functionality
 * for all controller classes in the application.
 * 
 * It defines:
 * - Standard operation constants (Save, Update, Delete, etc.)
 * - Common validation and preprocessing hooks
 * - DTO population logic (audit fields like createdBy, modifiedBy, timestamps)
 * - Centralized request handling via overridden service() method
 * 
 * All specific controllers extend this class and implement required methods.
 * 
 * Key responsibilities:
 * - Validate request data before processing
 * - Preload data for views (e.g., dropdowns)
 * - Populate DTO/Bean objects from request parameters
 * - Control request flow (forward/redirect)
 * 
 * @author Nimish
 */
public abstract class BaseCtl extends HttpServlet {
     ...
     * 
     * Typically used to populate dropdown lists or reference data.
     ...
     * - Sets createdBy and modifiedBy
     * - Sets createdDatetime and modifiedDatetime
     * 
     ...
     * 
     * Flow:
     * - Calls preload() to prepare data
     * - Reads operation parameter
     * - Performs validation (except for specific operations)
     * - If validation fails → forwards back to view
     * - Otherwise → delegates to HttpServlet service()
     * 
     * @param request  HttpServletRequest object
