 ...
 * - Preloading role list for dropdown
 * - Adding new user records
 * - Updating existing user records
 * - Fetching user details by ID
 * - Navigation control for user views
 * 
 * Flow:
 * - GET request → loads user data (if id present) and forwards to view
...
public class UserCtl extends BaseCtl{
    ...
    protected void preload(HttpServletRequest request) {
        ...
        try {
            ...
            System.out.println("roleList sizr ==>" + roleList.size());
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if (DataValidator.isNull(request.getParameter("login"))) {
            ...
            pass = false;
        } else if (DataValidator.isName(request.getParameter("login"))) {
     ...
     * Handles GET request.
     * 
     * If id is present, fetches user data and sets it in request scope.
     * Then forwards to user view.
     * 
     * @param request  HttpServletRequest object
     ...
     * - Save → adds new user record
     * - Update → updates existing user record
     * - Cancel → redirects to user list
     * - Reset → reloads form
     * 
